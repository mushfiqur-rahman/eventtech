  ...
  return (
    <>
      <ScrollToTop
        smooth
        top={20}
        component={<HiOutlineChevronDoubleUp />}
        ...
        <div className="p-5 ">
          <ul>
            ...
            <div className="flex gap-6 pb-5">
              <a
                href="https://www.facebook.com/eventtechbd"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/company/eventtechbd/"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UCcCQ3paVGm4B_-N3OXSjXqA"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="flex flex-col justify-center items-center text-center p-5">
        <h1 className="text-sm text-gray-500">
          ©2017 - {date} All rights reserved by{" "}
          <Link href="https://www.eventtechbd.com/">
            <a>Eventtech</a>
          </Link>{" "}
          | Developed by{" "}
          <span className="hover:text-blue-600 cursor-pointer">
            <Link href="https://mushfiq.xyz/">
              <a target="_blank">MUSHFIQ</a>
            </Link>
          </span>
        </h1>
      </div>
